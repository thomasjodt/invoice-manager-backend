...
public class InvoicesRepository implements InvoiceIRepository {
    ...
    public ResponseDTO<List<Invoice>> getAll() {
        List<Invoice> list = em.createQuery("SELECT i FROM Invoice i ORDER BY i.emissionDate DESC, i.vendor.name ASC, i.invoiceNumber DESC", Invoice.class).getResultList();
    ...
    public ResponseDTO<List<Invoice>> getAll(Integer limit, Integer offset) {
        TypedQuery<Invoice> q = em.createQuery("SELECT i FROM Invoice i ORDER BY i.emissionDate DESC, i.vendor.name ASC, i.invoiceNumber DESC", Invoice.class);
        Integer count = getCount();
    ...
    public ResponseDTO<List<Invoice>> getInvoicesByVendor(Long vendorId) {
        TypedQuery<Invoice> q = em.createQuery("SELECT i FROM Invoice i WHERE i.vendor.id=:vendorId ORDER BY i.emissionDate DESC, i.invoiceNumber DESC", Invoice.class);
